						...
						<table width="100%">
							<tr>
								<td style="text-align: center;">
									...
									<br />
									<h3>{{pelamar_nama}}</h3>
									<p>Anda telah lulus pada tahapan tes online kami dan menjadi salah satu kandidat potensial bagi: </p>
									<h4>{{company_name}}</h4>
									<p>Untuk posisi</p>
									...
									<p>1. Login kedalam akun anda di https://karir.sbpgroup.id.</p>
									<p>2. Klik menu interview.</p>
									<p>3. Pilih jawaban Anda.</p>
									<br />
									<br />
                  <p>Best Regards,</p>
