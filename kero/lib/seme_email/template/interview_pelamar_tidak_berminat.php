...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Pelamar Tidak Berminat Interview {{interview_utype}}</title>
			...
			<tr>
				...
				<td class="container" bgcolor="#FFFFFF">
						...
						<table width="100%">
							<tr>
								<td style="text-align: center;">
									<h1><b>Pelamar Tidak Berminat Interview {{interview_utype}}</b></h1>
									<br />
									<br />
									<h3>YTH Admin &amp; Interviewer,</h3>
									<p>Sistem mendapatkan informasi dari pelamar bahwa yang bersangkutan tidak berminat mengikuti interview. Berikut ini adalah informasi detailnya:</p>
                  ...
                  <p>Lokasi: {{interview_lokasi}} {{interview_keterangan}}.</p>
									...
									<p>Alasan Pelamar: {{interview_notes}}.</p>
									<p>Interview ini telah dibatalkan secara otomatis oleh sistem.</p>
									<br />
									<br />
                  <p>Best Regards,</p>
