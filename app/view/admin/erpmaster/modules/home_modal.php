	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="ftambah" action="<?=base_url(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<select id="ichildren_identifier" name="children_identifier" class="form-control select2"  style="width: 100%">
					...
					<div class="form-group form-actions">
						<div class="col-xs-12 text-right">
							...
							<button type="submit" class="btn btn-sm btn-primary btn-submit">Simpan <i class="fa fa-save icon-submit"></i></button>
						</div>
					</div>
				</form>
			</div>
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<select id="iechildren_identifier" name="children_identifier" class="form-control select2" style="width: 100%" >
									<option value="null">-</option>
									<?php foreach($modules as $momod){ ?>
									<option value="<?=$momod->identifier?>"><?=$momod->identifier?></option>
									<?php } ?>
