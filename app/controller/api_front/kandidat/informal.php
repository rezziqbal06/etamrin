...
* API_Front/kandidat
*/
class Informal extends JI_Controller {
  public $data_utype = 'Informal';
  public $currentDataProgress = 'Riwayat Pendidikan Non-Formal';
  ...
  public function baru(){
    ...
    $this->_setULog($dt['sess']->user->id, 13, 'riwayat pendidikan non formal');
