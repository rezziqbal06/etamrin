...
* API_Front/kandidat
*/
class Referensi extends JI_Controller {
  public $data_utype = 'Referensi';
  public $currentDataProgress = 'Data Referensi &amp; Rekomendasi';
  ...
  public function baru(){
    ...
    if(empty(strlen($telp))){
      $this->status = 1102;
      $this->message = 'Telp harus diisi';
      $this->__json_out($data);
    }
    ...
    $this->_setULog($dt['sess']->user->id, 13, 'referensi');
  ...
  public function edit($id){
    ...
    if(empty(strlen($telp))){
      $this->status = 1102;
      $this->message = 'Telp / Nomor HP harus diisi';
      $this->__json_out($data);
    }
