...
* API_Front/kandidat
*/
class Komputer extends JI_Controller {
  public $data_utype = 'komputer';
  public $currentDataProgress = 'Kemampuan Komputer';
  public $cert_name = 'sertifikat_komputer';
  ...
  public function baru(){
    ...
    if(empty(strlen($nama)) || empty(strlen($nilai)) ){
      $this->status = 1102;
