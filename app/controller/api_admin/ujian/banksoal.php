...
class BankSoal extends JI_Controller{
	...
	public function index(){
		...
		$dcount = $this->absm->countAll($keyword,$utype,$is_active,$is_mandatory);
		$ddata = $this->absm->getAll($page,$pagesize,$sortCol,$sortDir,$keyword,$utype,$is_active,$is_mandatory);
	...
	public function get(){
		...
		$p->id = 'NULL';
		$p->text = '-';
		$data = $this->absm->getSearch($keyword,0,1);
